...
export default function Carrinho() {
  const { itens, excluirItem, editarItem } = useLista();
...
const handleEditar = (item) => {
  ...
  if (novoPreco === null) return; // 👈 evita erro
  ...
  if (novaQtd === null) return; // 👈 evita erro
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white shadow-xl rounded-xl p-6">
      <h2 className="text-2xl font-bold text-green-800 mb-4">🛒 Itens no Carrinho</h2>
